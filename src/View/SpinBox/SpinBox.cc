...
SpinBox::SpinBox(const double initial_value, const double multiplier,
  ...
  line_edit_ = new SpinBoxLineEdit(current_value_, multiplier_, min_value_,
                                   max_value_, this);
  push_button_ = new SpinBoxPushButton(current_value_, multiplier_, min_value_,
                                       max_value_, this);
...
void SpinBox::ToggleEditing() {
  /* Commented to use just button, not line edit*/
